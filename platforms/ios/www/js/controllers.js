...
.controller('PostConfirmCtrl', function ($scope, $ionicPlatform, $cordovaFileTransfer, $http) {
    $scope.goBack = function () {
        $ionicHistory.nextViewOptions({
            disableBack: true
        });
    ...
    $scope.confirmPost = function () {
        ...
        $cordovaFileTransfer.upload('https://instafake-api.herokuapp.com/upload', $rootScope.picture, options).then(function (result) {
    ...
    $scope.testConnection = function () {
        $http.get('https://instafake-api.herokuapp.com/').then(function (result) {
